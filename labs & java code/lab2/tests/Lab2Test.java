...
public class Lab2Test {
	...
	public void problem3() {
		...
		assertEquals("Number too small!", Main.problem3_reverseAndSubtract(89));
	...
	public void problem6() {
		assertEquals(0, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 10, 0), 1.0, 60));
		assertEquals(100, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 51), 1.0, 60));
		assertEquals(35400, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0), 
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 1), 1.0, 60));
		assertEquals(10, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 59), 1.0, 60));
		assertEquals(0, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 10, 0), 0.5, 60));
		assertEquals(0, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 51), 0.5, 60));
		assertEquals(17400, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0), 
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 1), 0.5, 60));
		assertEquals(0, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 59), 0.5, 60));
		assertEquals(600, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 10, 0), 2, 60));
		assertEquals(810, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 51), 2, 60));
		assertEquals(71400, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0), 
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 1), 2, 60));
		assertEquals(620, Main.problem6_checkSpeed(LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 0),
				LocalDateTime.of(2023, Month.OCTOBER, 31, 6, 9, 59), 2, 60));
	}
	...
	public void problem8() {
		...
		assertEquals(23.55, Math.round(d.getMeters() * 100.0) / 100.0, EPSILON);
		assertEquals(2355.20, Math.round(d.getCentimeters() * 100.0) / 100.0, EPSILON);
		assertEquals(77.27, Math.round(d.getFeet() * 100.0) / 100.0, EPSILON);
		assertEquals(927.24, Math.round(d.getInches() * 100.0) / 100.0, EPSILON);
		assertEquals(0.024, Math.round(d.getKilometers() * 1000.0) / 1000.0, EPSILON);
		assertEquals(0.015, Math.round(d.getMiles() * 1000.0) / 1000.0, EPSILON);
	}

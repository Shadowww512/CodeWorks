...
public class Lab4Test {
	...
	public void problem2() {
		...
		assertEquals("Id: 1, Name: Bob N., Amount: $360.0", payroll.getPaycheck(1));
		assertEquals("Id: 2, Name: Emily Navarro, Amount: $4125.0", payroll.getPaycheck(2));
		assertEquals("Id: 3, Name: Sheila Burns, Amount: $615.14", payroll.getPaycheck(3));

		payroll.removeEmployee(2);
		assertEquals("Error: No employee found with id 2", payroll.getPaycheck(2));

		Employee greg = new Employee("Greg", 0, 65.2, 110);
		payroll.addEmployee(greg);
		assertEquals(4, greg.getId());
		assertEquals("Id: 4, Name: Greg, Amount: $0.0", payroll.getPaycheck(4));

		robert.setHoursWorked(0);
		assertEquals("Id: 1, Name: Bob N., Amount: $0.0", payroll.getPaycheck(1));
	}
